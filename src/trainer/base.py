...
class BaseTrainer(metaclass=ABCMeta):
    ...
    def __init__(self, model, criterion, metric_ftns, optimizer, config):
        ...
        self.model = DistributedDataParallel(model, device_ids=[self.device], output_device=self.device, find_unused_parameters=True)
        ...
        metric_names = ["total", *[n for n in criterion.names], *[m.__name__ for m in self.metric_ftns]]
