...
class FunctionAdaCoF(torch.autograd.Function):
    ...
    def forward(ctx, input, weight, offset_i, offset_j, dilation):
        ...
        if input.is_cuda == True:
            ...
            cupy_launch(
                "kernel_AdaCoF_updateOutput",
                cupy_kernel("kernel_AdaCoF_updateOutput", intFilterSize, dilation, {"input": input, "weight": weight, "offset_i": offset_i, "offset_j": offset_j, "output": output}),
            )(
    ...
    def backward(ctx, gradOutput):
        ...
        if input.is_cuda == True:
            ...
            cupy_launch(
                "kernel_AdaCoF_updateGradWeight",
                cupy_kernel("kernel_AdaCoF_updateGradWeight", intFilterSize, dilation, {"gradLoss": gradOutput, "input": input, "offset_i": offset_i, "offset_j": offset_j, "gradWeight": gradWeight}),
            )(
            ...
            cupy_launch(
                ...
                cupy_kernel(
                    ...
                    intFilterSize,
                    dilation,
                    {"gradLoss": gradOutput, "input": input, "weight": weight, "offset_i": offset_i, "offset_j": offset_j, "gradOffset_i": gradOffset_i},
                ),
            )(
            ...
            cupy_launch(
                ...
                cupy_kernel(
                    ...
                    intFilterSize,
                    dilation,
                    {"gradLoss": gradOutput, "input": input, "weight": weight, "offset_i": offset_i, "offset_j": offset_j, "gradOffset_j": gradOffset_j},
                ),
            )(
